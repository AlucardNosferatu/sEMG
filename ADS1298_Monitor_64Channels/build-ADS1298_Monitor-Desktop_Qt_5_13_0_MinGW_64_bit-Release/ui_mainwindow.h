...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget->setGeometry(QRect(10, 0, 843, 151));
        ...
        pushButton_workBench = new QPushButton(widget);
        ...
        spinBox_fileName = new QSpinBox(widget);
